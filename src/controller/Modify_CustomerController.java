...
public class Modify_CustomerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        modifyCustomerLabel.setText(this.rb.getString("modifyCustomer"));
    ...
    dbQuery.updateCustomerSQL(customerID, customerName, address, postalCode, phone, C195.loggedInUser, divisionId,formattedLastUpdated);
    ...
    @FXML
    private void onActionCustomerNameTxtBox(ActionEvent event) {
    }

    @FXML
    private void onActionAddressTxtBox(ActionEvent event) {
    }

    @FXML
    private void onActionPhoneNumberTxtBox(ActionEvent event) {
    }

    @FXML
    private void onActionPostalCodeTxtBox(ActionEvent event) {
    }

    @FXML
    private void onActionCustomerIdTxtBox(ActionEvent event) {
    }

    @FXML
    private void onActionCountryComboBox(ActionEvent event) {
    ...
    /**
     *import customer info from customer form tableview
     * @param customer customer
     */
    public void importCustomerInfo(Customer customer){
    Customer getSelectedCustomerName = customer; 
    ...
    postalCodeTxtBox.setText(customer.getPostalCode());
    phoneNumberTxtBox.setText(customer.getPhoneNumber());
    countryComboBox.getSelectionModel().select(customer.getCountry());
    stateProvidenceComboBox.getSelectionModel().select(customer.getState());
    ...
    /**
     *Data validation for customer input fields
    ...
    exception.popUp(this.rb.getString("Customer_name_is_empty"),this.rb.getString ("Please_fill_in_customer_name"));
    return false;
    }
